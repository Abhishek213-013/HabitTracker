  ...
  Future<void> _register() async {
    ...
    if (!_termsAccepted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Accept the terms & conditions to proceed😊')),
      );
      return;
    }
    ...
    if (error == null && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(error ?? 'Ohho Registration failed😔')),
      );
    }
  }
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      if (!RegExp(r'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).+$')
                          .hasMatch(value)) {
                        return 'Do not forget to include uppercase, lowercase and numbers :)';
                      }
                      return null;
                    },
                  ),
